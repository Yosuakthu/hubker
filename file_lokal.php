...
?>
        ...
        <?php
          ...
          INNER JOIN respon ON document.id_respon = respon.id_respon WHERE document.id_tingkatan = 3 AND document.id_respon = 3");
        ?>
 ...
 <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Fie Document Kerjasama Tingkatan Wilaya/Lokal</h4>
